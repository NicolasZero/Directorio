...
const Footer = () => {
    return (
        <footer className="p-4 container mx-auto">
            <Card className="bg-rose-600 dark:bg-rose-900 text-white ">
                <CardContent className="p-8 md:p-12">
                    ...
                    <div className="text-center mt-8">
                        <Button className="bg-white/10 hover:bg-white/20 transition-colors hover:text-white border-0" variant="outline" size="lg">
                            Contáctanos
