...
const directoriosData: DirectoryEntry[] = [
	...
	{
		id: 11,
		nombre: 'Centro de Atención Vargas',
		direccion: 'Av. Principal, Maiquetía',
		telefono: '(0212) 555-6666',
		municipio: 'Vargas',
		estado: 'Vargas',
	},
	// Carabobo
	{
		id: 12,
		nombre: 'Inamujer Carabobo',
		direccion: 'Av. Bolívar, Valencia',
		telefono: '(0241) 555-7777',
		municipio: 'Valencia',
		estado: 'Carabobo',
	},
	// Bolívar
	{
		id: 13,
		nombre: 'Centro Inamujer Bolívar',
		direccion: 'Av. Guayana, Ciudad Bolívar',
		telefono: '(0285) 555-8888',
		municipio: 'Caroní',
		estado: 'Bolívar',
	},
	// Táchira
	{
		id: 14,
		nombre: 'Inamujer Táchira',
		direccion: 'Av. Libertador, San Cristóbal',
		telefono: '(0276) 555-9999',
	...
	{
		id: 15,
		nombre: 'Centro de la Mujer Merideña',
		direccion: 'Av.仙人掌, Mérida',
		telefono: '(0274) 555-1010',
		municipio: 'Libertador',
		estado: 'Mérida',
	},
	// Anzoátegui
	{
		id: 16,
		nombre: 'Inamujer Anzoátegui',
		direccion: 'Av. Barcelona, Puerto La Cruz',
		telefono: '(0281) 555-1111',
		municipio: 'Barcelona',
		estado: 'Anzoátegui',
	},
	// Sucre
	{
		id: 17,
		nombre: 'Centro Inamujer Sucre',
		direccion: 'Av. Universidad, Cumaná',
		telefono: '(0293) 555-1212',
		municipio: 'Cumaná',
		estado: 'Sucre',
	},
	// Monagas
	{
		id: 18,
		nombre: 'Inamujer Monagas',
		direccion: 'Av. Orinoco, Maturín',
		telefono: '(0291) 555-1313',
		municipio: 'Maturín',
		estado: 'Monagas',
	},
	// Portuguesa
	{
		id: 19,
		nombre: 'Centro de Atención Portuguesa',
		direccion: 'Av. Lara, Guanare',
		telefono: '(0255) 555-1414',
		municipio: 'Guanare',
		estado: 'Portuguesa',
	},
	// Barinas
	{
		id: 20,
		nombre: 'Inamujer Barinas',
		direccion: 'Av. Libertador, Barinas',
		telefono: '(0273) 555-1515',
		municipio: 'Barinas',
		estado: 'Barinas',
	},
	// Cojedes
	{
		id: 21,
		nombre: 'Centro Inamujer Cojedes',
		direccion: 'Av. Bolívar, San Carlos',
		telefono: '(0258) 555-1616',
	...
	{
		id: 22,
		nombre: 'Inamujer Apure',
		direccion: 'Av. Fernando Paz, San Fernando',
		telefono: '(0247) 555-1717',
	...
	{
		id: 23,
		nombre: 'Centro de Atención Falcón',
		direccion: 'Av. Federal, Coro',
		telefono: '(0269) 555-1818',
		municipio: 'Coro',
		estado: 'Falcón',
	},
	// Yaracuy
	{
		...
		direccion: 'Av. Ramírez, San Felipe',
		telefono: '(0254) 555-1919',
	...
	{
		id: 25,
		nombre: 'Centro Inamujer Trujillo',
		direccion: 'Av. Bolívar, Trujillo',
		telefono: '(0272) 555-2020',
		municipio: 'Trujillo',
		estado: 'Trujillo',
	},
	// Guárico
	{
		id: 26,
		nombre: 'Inamujer Guárico',
		direccion: 'Av. Miranda, San Juan de los Morros',
		telefono: '(0234) 555-2121',
	...
	{
		id: 27,
		nombre: 'Centro de Atención Amazonas',
		direccion: 'Av. Orinoco, Puerto Ayacucho',
		telefono: '(0248) 555-2222',
		municipio: 'Atures',
		estado: 'Amazonas',
	},
	// Delta Amacuro
	{
		id: 28,
		nombre: 'Inamujer Delta Amacuro',
		direccion: 'Av. José Antonio, Tucupita',
		telefono: '(0287) 555-2323',
		municipio: 'Tucupita',
	...
	{
		id: 29,
		nombre: 'Centro Inamujer Nueva Esparta',
		direccion: 'Av. Raúl, La Asunción',
		telefono: '(0295) 555-2424',
		municipio: 'La Asunción',
...
const MapaInteractivo = () => {
	...
	const handleClick = (e: any) => {
		...
		// Buscar el estado correspondiente al ID del SVG
		const estadoNombre = estadoIdMap[id] || nombre;
	...
	return (
		<div className="min-h-screen">
			...
			<section>
				...
				{/* Mapa de Venezuela */}
				<div className="map-container w-[90%] max-w-4xl mx-auto my-5 flex justify-center overflow-auto border rounded-xl shadow-lg">
