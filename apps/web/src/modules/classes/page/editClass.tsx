    ...
    <div className="min-h-screen">
      <form onSubmit={handleSubmit}>
        <section className="py-10 px-4 sm:px-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h1 className="text-3xl font-bold text-foreground md:text-4xl">Editar clase</h1>
        ...
        <section className="py-8 px-4 sm:px-8 bg-muted/30">
          <SectionHeader title="Módulos" description="Agrega o edita los módulos del curso." />
        ...
        <section className="py-10 px-4 sm:px-8">
          <div className="max-w-2xl space-y-4">
            ...
            <Button type="button" variant="outline" onClick={() => navigate('/admin/clases')}>
              Volver sin guardar
            </Button>
            {error && (
